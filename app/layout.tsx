...
export const metadata: Metadata = {
  ...
  title: {
    ...
    default: "QuizPlatform Pro - Online Test Series & Competitive Exams Tests",
  },
  ...
  keywords: ["quiz platform", "competitive exams", "test series", "test", "GK quiz", "online exams", "MPSC test", "result analysis"],
  manifest: "/manifest.webmanifest",
  alternates: { canonical: "/" },
  openGraph: {
    type: "website",
    siteName: "QuizPlatform Pro",
    title: "QuizPlatform Pro - Online Test Series & Competitive Exams Tests",
  ...
  twitter: {
    card: "summary",
    title: "QuizPlatform Pro - Online Tests",
